...
define Device/AX3000_1600_VDSL35B_11AX_SEC_DEBUG
  ...
  FAKED_ENV := $(FAKEROOT_PROG)
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES := $(UGW_PACKAGES_SEC) $(UGW_PACKAGES_SEC_DEBUG) $(VOIP_PACKAGES_SEC) $(DSL_CPE_UGW_PACKAGE) $(DSL_CPE_PACKAGES_R5) $(DSL_CPE_PACKAGES_DEBUG) $(DECT_PACKAGES_SEC) $(DECT_PACKAGES_SEC_DEBUG) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) $(AX_PACKAGES)
endef
...
define Device/AX3000_1600_ETH_11AX_SEC_DEBUG
  ...
  FAKED_ENV := $(FAKEROOT_PROG)
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES := $(UGW_PACKAGES_SEC) $(UGW_PACKAGES_SEC_DEBUG) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) $(AX_PACKAGES) $(OVPN_PACKAGES)
endef
...
define Device/AX6000_2000_ETH_11AX_SEC_DEBUG
  ...
  FAKED_ENV := $(FAKEROOT_PROG)
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES := $(UGW_PACKAGES_SEC) $(UGW_PACKAGES_SEC_DEBUG) $(WAV600_UGW_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI)
endef
...
define Device/AX6000_2000_VDSL35B_11AX_SEC_DEBUG
  ...
  FAKED_ENV := $(FAKEROOT_PROG)
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES := $(UGW_PACKAGES_SEC) $(UGW_PACKAGES_SEC_DEBUG) $(DSL_CPE_UGW_PACKAGE) $(DSL_CPE_PACKAGES_R5) $(DSL_CPE_PACKAGES_DEBUG) $(VOIP_PACKAGES_SEC) $(DECT_PACKAGES_SEC) $(DECT_PACKAGES_SEC_DEBUG) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) $(AX_PACKAGES)
endef
...
define Device/AX6000_2000_GFAST_11AX_SEC_DEBUG
  ...
  FAKED_ENV := $(FAKEROOT_PROG)
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES := $(UGW_PACKAGES_SEC) $(UGW_PACKAGES_SEC_DEBUG) $(VOIP_PACKAGES_SEC) $(DSL_CPE_GFAST_PACKAGES) $(DSL_CPE_GFAST_PACKAGES_DEBUG) $(DECT_PACKAGES_SEC) $(DECT_PACKAGES_SEC_DEBUG) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) $(AX_PACKAGES)
endef
